...
const course_2_step_3 = () => {
  const router = useRouter();

  const handleClick = () => {
    router.push('/courses/course_2/lesson_2');
  };
  ...
  return (
    ...
    <circle cx="60" cy="60" r="64" transform="matrix(1 0 0 -1 330 459)" fill="#519546" stroke="#FFFFFD" stroke-width="8" onClick={handleClick}/>
...
export default course_2_step_3;
